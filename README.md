...
- **Aggregates job postings** from public and web sources to surface real-time hiring activity in the Montgomery region
...
> _To be finalized during the build phase (Mar 5–9)._

| Layer | Tools |
|---|---|
| Data Collection | Bright Data (web scraping), Montgomery Open Data Portal |
| AI / Analysis | _TBD_ |
| Backend | _TBD_ |
| Frontend / Dashboard | _TBD_ |
| Deployment | _TBD_ |
